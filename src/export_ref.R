...
# Created: 17/07/2021
#
# This script compiles BIO-MATE citations into one BibTeX file to be used for referencing datasets and cruise metadata. 
# This file can be used to create a reference list to appropriately cite BIO-MATE and it's datasets, using reference managers or document editing software (e.g. R Markdown, LaTEX). 
#
# 
#
# EXPOCODE - A list of the EXPOCODES for the data you have used. Deefault is "all"
# stream - The data streams you have used. Can be "all" or a combination of "PIG", "PROF","POC' and "UWY"
# path_out - where you want the BibTeX file to be saved.
