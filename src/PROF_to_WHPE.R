...
# The metadata file must be named "PROF_meta.csv"
# All PROF/CTD files must be singular per cast with the same extention, in one folder.
# Use the split_compiled_delim_file.R to convert files to this format.
#
# Downloaded files
#
...
# row_end - the end row
# trace_file - TRUE will print out each file name as it is reformatted, FALSE suppresses this
